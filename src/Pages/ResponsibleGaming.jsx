...
const ResponsibleGaming = () => {
  ...
  {/* <img src={Gaming} alt="Terms and Conditions" style={styles.image} /> */}
    ...
    <div style={styles.container}>
      <h1 style={styles.header}>Responsible Gaming at IPL GO Fantasy</h1>
      
      <h2 style={styles.subHeader}>Commitment to Responsible Gaming</h2>
      <p style={styles.section}>
        IPL GO Fantasy is committed to responsible gaming and, as part of its corporate social responsibility, advises its users to follow responsible gaming practices as mentioned in the IPL GO Fantasy Responsible Gaming guide.
      </p>
      <p style={styles.section}>
        At IPL GO Fantasy, we are dedicated to ensuring that our users have a fun, entertaining, safe, secure, and responsible gaming experience. Thus, we have implemented a strict Responsible Gaming Policy.
      </p>

      <h2 style={styles.subHeader}>Responsible Gaming Policy for Fantasy</h2>
      <p style={styles.section}>
        IPL GO Fantasy appreciates your love of gaming. As a result, we have implemented strict guidelines so that you can play your game and excel at it. Our player-focused project, Responsible Gaming for Fantasy Games, includes a list of carefully developed guidelines that you must follow in order to keep using our site.
      </p>
      <p style={styles.section}>
      ...
      <ul style={styles.list}>
        ...
        <li>Additionally, we forbid gamers under the age of 18 from using our services. Please note that you cannot allow any children to play through your IPL GO Fantasy profile if you are an adult.</li>
      </ul>
      <p style={styles.section}>
