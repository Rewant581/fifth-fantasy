...
const Legalities = () => {
  return (
    ...
    <div style={styles.container}>
      ...
      <p style={styles.section}>
        IPL GO Fantasy is completely legal as it offers services, Fun Features, Program(s), and Contest(s) related to fantasy cricket, fantasy football, fantasy kabaddi, fantasy volleyball, fantasy basketball, and fantasy hockey. The services, contest(s), and program(s) related to online fantasy sports gaming offered by IPL GO Fantasy enable its users to create their own team prior to the match beginning and then the teams are awarded points based on the real-life performance of the players chosen by the users in the team. The individual whose team scores the highest aggregate of points is announced as the winner. The formation of the team by the users of IPL GO Fantasy is entirely dependent on the skills, knowledge, and attention of the users, which makes online fantasy sports gaming offered at IPL GO Fantasy a game of skills and 100% legal.
      </p>
      ...
      <p style={styles.section}>
        In this context, IPL GO Fantasy does not permit the users identified as the residents of Sikkim, Odisha, Telangana, Assam, Nagaland, and Andhra Pradesh to participate in the pay-to-play contest(s) organized by IPL GO Fantasy.
      </p>
