    ...
    <div className="home-container">
      ...
      <section className="hero-section">
        <div className="hero-content">
          <h1>IPL GO FANTASY - IS THE BEST FANTASY GAME IN INDIA</h1>
          <p className="sub-text">100+ downloads daily</p>
          <div className="download-icon">
            <i className="fa fa-cloud-download" aria-hidden="true"></i>
          </div>
          <p className="description">
            IPL GO FANTASY takes the excitement of real-life sports and combines it with the thrill of strategy and competition.
          </p>
      ...
      <section className="about-dfs-section">
        <h2>About IPL GO Fantasy Sports</h2>
        <div className="dfs-details">
          <div className="dfs-text">
            <h3>What is IPL GO Fantasy Sport?</h3>
            <p>IPL GO Fantasy Sports is a quick and exciting way to play fantasy sports. Unlike traditional fantasy leagues that span an entire season, DFS contests last for just one day or one week. Players draft virtual teams of real-life athletes and compete based on their performance in real games.</p>
      ...
      <section className="testimonials-section">
        ...
        <div className="testimonials">
          <div className="testimonial">
            <p>"IPL GO has completely changed the way I enjoy sports. The app is fantastic!"</p>
            <h4>- Rahul</h4>
          </div>
          <div className="testimonial">
            <p>"I love the competition and the thrill of winning prizes. Highly recommend IPL GO!"</p>
            <h4>- Priya</h4>
          </div>
        </div>
      </section>
      ...
      <section className="call-to-action-section">
        <h2>Join the IPL GO Community Today!</h2>
      ...
      <section className="how-to-play-section">
        ...
        <div className="steps">
          <div className="step">
            ...
            <p>Get the IPL GO app from the app store and create your account.</p>
          </div>
          <div className="step">
      ...
      <section className="faq-section">
        ...
        <div className="faqs">
          <div className="faq">
            <h3>What is IPL GO?</h3>
            <p>IPL GO is a fantasy sports app where you can create your own teams and compete against others to win prizes.</p>
          </div>
          <div className="faq">
